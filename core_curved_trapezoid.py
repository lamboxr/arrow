...
class CoreCurvedTrapezoidWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        try:
            ...
            painter.drawText(20, 30, "核心弯曲梯形 - 3参数控制")
            ...
            painter.drawText(20, 150, "渐变腰线特性:")
            painter.drawText(20, 170, f"• 顶部: {GRADIENT_COLORS['top']} (完全透明)")
            painter.drawText(20, 190, f"• 中间: {GRADIENT_COLORS['middle']} (50%透明)")
            painter.drawText(20, 210, f"• 底部: {GRADIENT_COLORS['bottom']} (完全透明)")
